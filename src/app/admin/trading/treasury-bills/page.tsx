...
export default function TreasuryBillsPage() {
  ...
  const fetchTreasuryBills = async () => {
    try {
      ...
      const data: AuctionsResponse = await tradingApi.getTreasuryBills({
      ...
      console.error('Error fetching treasury bills:', error);
      setError(error instanceof Error ? error.message : 'Failed to fetch treasury bills');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">Treasury Bills</h1>
          </div>
          <p className="text-sm text-muted-foreground">
            Manage short-term government securities (91-day, 182-day, 364-day Treasury Bills)
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <div className="space-y-2">
            <p className="text-2xl font-bold text-foreground">{formatCurrency(2500000000)}</p>
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <div className="space-y-2">
            <p className="text-2xl font-bold text-foreground">14.75%</p>
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center text-sm">
              <span className="text-muted-foreground">2 closing today</span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-card border border-border rounded-xl">
        <div className="p-6 border-b border-border">
          <h2 className="text-lg font-semibold text-foreground">Treasury Bill Auctions</h2>
        ...
        {loading ? (
          <div className="p-12 text-center">
            ...
            <p className="text-muted-foreground mt-4">Loading treasury bills...</p>
          </div>
        ) : error ? (
          <div className="p-12 text-center">
            <p className="text-red-500 mb-4">{error}</p>
            <button 
              onClick={fetchTreasuryBills}
